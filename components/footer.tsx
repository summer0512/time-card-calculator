  ...
  return (
    <footer className="bg-gray-900 text-white">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-8">
        ...
        <div className="mt-8 pt-6 border-t border-gray-800 grid grid-cols-1 md:grid-cols-2 gap-3">
          <div>
          ...
          <p className="text-gray-400 text-sm md:text-right">Copyright 2026 Time Card Calculator. All rights reserved.</p>
        </div>
      </div>
    </footer>
  );
